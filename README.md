...
- Keep the 2–3 administrator email addresses in a server-only allowlist. Staff may be promoted from Employee to Lead to Manager, but never to Administrator.
